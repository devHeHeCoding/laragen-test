                    ...
                    @forelse($items as $item)
                        <tr>
                                ...
                                <div class="form-group">
                                                                                                                <a href="{{ route('laragentest_cars.show', ['testcar1952538869' => $item->id])}}" class="btn btn-secondary">
                                            {{ trans('global.show') }}
                                        </a>
                                                                                                                <a href="{{ route('laragentest_cars.edit', ['testcar1952538869' => $item->id])}}" class="btn btn-secondary">
                                            {{ trans('global.edit') }}
                                        </a>
