<x-laragen::form wire:submit.prevent="submit" class="pt-3">
        ...
        <div class="flex-1 -mx-2">
                                            @includeFirst([
                            'admin.crud-controller.testcontroller.create.mrs._margot_kub_id',
                            'admin.generated.crud-controller.testcontroller.create.mrs._margot_kub_id'
                        ])
                @includeIf('admin.crud-controller.testcontroller.create.mrs._margot_kub_id_after')
                    </div>
    </fieldset>
