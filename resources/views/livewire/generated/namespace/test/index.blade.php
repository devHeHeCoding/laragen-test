            ...
            <div class="overflow-hidden shadow rounded">
                <table class="laragen-table">
                    ...
                    <tr>
                            ...
                            <th>
                                {{ trans('cruds.test-car1384594070.fields.test') }}                            </th>
                        ...
                        <tr>
                                ...
                                <div class="form-group">
                                    ...
                                    @if(!$hideDefaultActions)
                                        ...
                                        <x-laragen::button variant="text" size="xs" icon="fa-light fa-eye" href="{{ route('laragen.admin.route.prefix.show', ['testCar1384594070' => $item->id]) }}"></x-laragen::button>
                                    
                                    
                                        
                                        <x-laragen::button variant="text" size="xs" icon="fa-light fa-pencil" href="{{ route('laragen.admin.route.prefix.edit', ['testCar1384594070' => $item->id]) }}"></x-laragen::button>                                    
