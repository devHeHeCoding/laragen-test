            ...
            <div class="overflow-hidden shadow rounded">
                <table class="laragen-table">
                    ...
                    <tr>
                            ...
                            <th>
                                {{ trans('cruds.test-car1330947832.fields.test') }}                            </th>
                        ...
                        <tr>
                                ...
                                <div class="form-group flex">
                                    ...
                                    @if(!$hideDefaultActions)
                                        ...
                                        <x-laragen::button variant="text" size="xs" icon="fa-light fa-eye" href="{{ route('laragen.admin.route.prefix.show', ['testCar1330947832' => $item->id]) }}"></x-laragen::button>
                                        @endif
                                        ...
                                        @if(!$hideEditAction)
                                            ...
                                            <x-laragen::button variant="text" size="xs" icon="fa-light fa-pencil" href="{{ route('laragen.admin.route.prefix.edit', ['testCar1330947832' => $item->id]) }}"></x-laragen::button>                                        
                                        @endif
