        ...
        <fieldset>
            ...
            <div class="flex-1 -mx-2">
                @includeIf('app.namespace.test.create.fieldset.dr.content_before')
                                                        @includeIf('app.namespace.test.fields.create.has_many_relation_dr._ivy_o&#039;_keefe_m_d_id_before')
                    @includeFirst([
                                'app.namespace.test.fields.create.has_many_relation_dr._ivy_o&#039;_keefe_m_d_id',
                                'app.generated.namespace.test.fields.create.has_many_relation_dr._ivy_o&#039;_keefe_m_d_id'
                            ])
                    @includeIf('app.namespace.test.fields.create.has_many_relation_dr._ivy_o&#039;_keefe_m_d_id_after')
