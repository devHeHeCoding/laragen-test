        ...
        <fieldset>
            ...
            <div class="flex-1 -mx-2">
                @includeIf('app.namespace.test.create.fieldset.7.content_before')
                                    @includeIf('app.namespace.test.fields.create.trycia_lesch_id_before')
                    @includeFirst([
                                'app.namespace.test.fields.create.trycia_lesch_id',
                                'app.generated.namespace.test.fields.create.trycia_lesch_id'
                            ])
                    @includeIf('app.namespace.test.fields.create.trycia_lesch_id_after')
