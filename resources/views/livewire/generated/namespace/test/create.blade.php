        ...
        <fieldset>
            ...
            <div class="flex-1 -mx-2">
                @includeIf('app.namespace.test.create.fieldset.miss.content_before')
                                    @includeIf('app.namespace.test.fields.create.muriel_emmerich_id_before')
                    @includeFirst([
                                'app.namespace.test.fields.create.muriel_emmerich_id',
                                'app.generated.namespace.test.fields.create.muriel_emmerich_id'
                            ])
                    @includeIf('app.namespace.test.fields.create.muriel_emmerich_id_after')
