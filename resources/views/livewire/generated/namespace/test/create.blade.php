        ...
        <fieldset>
            ...
            <div class="flex-1 -mx-2">
                @includeIf('app.namespace.test.create.fieldset.dr.content_before')
                                    @includeIf('app.namespace.test.fields.create.erna_mc_clure_id_before')
                    @includeFirst([
                                'app.namespace.test.fields.create.erna_mc_clure_id',
                                'app.generated.namespace.test.fields.create.erna_mc_clure_id'
                            ])
                    @includeIf('app.namespace.test.fields.create.erna_mc_clure_id_after')
