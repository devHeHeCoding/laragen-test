        ...
        <fieldset>
            ...
            <div class="flex-1 -mx-2">
                @includeIf('app.namespace.test.create.fieldset.prof.content_before')
                                    @includeIf('app.namespace.test.fields.create.has_many_relation_angelita_kessler_id_before')
                    @includeFirst([
                                'app.namespace.test.fields.create.has_many_relation_angelita_kessler_id',
                                'app.generated.namespace.test.fields.create.has_many_relation_angelita_kessler_id'
                            ])
                    @includeIf('app.namespace.test.fields.create.has_many_relation_angelita_kessler_id_after')
