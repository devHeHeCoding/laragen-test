        ...
        <fieldset>
            ...
            <div class="flex-1 -mx-2">
                @includeIf('app.namespace.test.create.fieldset.prof.content_before')
                                    @includeIf('app.namespace.test.fields.create.lyla_davis_id_before')
                    @includeFirst([
                                'app.namespace.test.fields.create.lyla_davis_id',
                                'app.generated.namespace.test.fields.create.lyla_davis_id'
                            ])
                    @includeIf('app.namespace.test.fields.create.lyla_davis_id_after')
