<x-laragen::form wire:submit.prevent="submit" class="pt-3">
        ...
        <div class="flex-1 -mx-2">
                                            @includeFirst([
                            'app.namespace.test.fields.create.dr._lesley_jakubowski_id',
                            'app.generated.namespace.test.fields.create.dr._lesley_jakubowski_id'
                        ])
                @includeIf('app.namespace.test.fields.create.dr._lesley_jakubowski_id_after')
                    </div>
    </fieldset>
