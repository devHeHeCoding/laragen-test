        ...
        <fieldset>
            ...
            <div class="flex-1 -mx-2">
                @includeIf('app.namespace.test.create.fieldset.mr.content_before')
                                                        @includeIf('app.namespace.test.fields.create.has_many_relation_bennie_feil_id_before')
                    @includeFirst([
                                'app.namespace.test.fields.create.has_many_relation_bennie_feil_id',
                                'app.generated.namespace.test.fields.create.has_many_relation_bennie_feil_id'
                            ])
                    @includeIf('app.namespace.test.fields.create.has_many_relation_bennie_feil_id_after')
