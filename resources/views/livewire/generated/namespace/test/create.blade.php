        ...
        <fieldset>
            ...
            <div class="flex-1 -mx-2">
                @includeIf('app.namespace.test.create.fieldset.7.content_before')
                                    @includeIf('app.namespace.test.fields.create.keely_hudson_id_before')
                    @includeFirst([
                                'app.namespace.test.fields.create.keely_hudson_id',
                                'app.generated.namespace.test.fields.create.keely_hudson_id'
                            ])
                    @includeIf('app.namespace.test.fields.create.keely_hudson_id_after')
