        ...
        <fieldset>
            ...
            <div class="flex-1 -mx-2">
                @includeIf('app.namespace.test.create.fieldset.7.content_before')
                                    @includeIf('app.namespace.test.fields.create.cordelia_hartmann_id_before')
                    @includeFirst([
                                'app.namespace.test.fields.create.cordelia_hartmann_id',
                                'app.generated.namespace.test.fields.create.cordelia_hartmann_id'
                            ])
                    @includeIf('app.namespace.test.fields.create.cordelia_hartmann_id_after')
