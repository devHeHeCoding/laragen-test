        ...
        <fieldset>
            ...
            <div class="flex-1 -mx-2">
                @includeIf('app.namespace.test.create.fieldset.miss.content_before')
                                                        @includeIf('app.namespace.test.fields.create.has_many_relation_dr._german_kunze_d_d_s_id_before')
                    @includeFirst([
                                'app.namespace.test.fields.create.has_many_relation_dr._german_kunze_d_d_s_id',
                                'app.generated.namespace.test.fields.create.has_many_relation_dr._german_kunze_d_d_s_id'
                            ])
                    @includeIf('app.namespace.test.fields.create.has_many_relation_dr._german_kunze_d_d_s_id_after')
