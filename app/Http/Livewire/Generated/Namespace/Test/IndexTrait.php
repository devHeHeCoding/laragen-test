...
trait IndexTrait
{
    ...
    {
        return TestCar1488929287::paginate($this->perPage);
    }

            public function delete(TestCar1488929287 $testCar1488929287): void
        {
                                                if ($testCar1488929287->testCar2611851973s()->count() > 0) {
