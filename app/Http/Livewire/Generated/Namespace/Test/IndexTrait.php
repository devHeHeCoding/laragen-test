...
trait IndexTrait
{
    ...
    {
        return TestCar1100389471::paginate($this->perPage);
    }

            public function delete(TestCar1100389471 $testCar1100389471): void
        {
                                                if ($testCar1100389471->testCar2397178112s()->count() > 0) {
