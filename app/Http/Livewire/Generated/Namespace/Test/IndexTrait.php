...
trait IndexTrait
{
    ...
    {
        return TestCar1159105796::paginate($this->perPage);
    }

            public function delete(TestCar1159105796 $testCar1159105796): void
        {
                                                if ($testCar1159105796->testCar2860904665s()->count() > 0) {
