...
trait IndexTrait
{
    ...
    {
        return TestCar1498983619::paginate($this->perPage);
    }

            public function delete(TestCar1498983619 $testCar1498983619): void
        {
                                                if ($testCar1498983619->testCar22138376989s()->count() > 0) {
