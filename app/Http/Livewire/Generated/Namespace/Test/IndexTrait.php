...
trait IndexTrait
{
    ...
    {
        return TestCar1965360481::paginate($this->perPage);
    }

            public function delete(TestCar1965360481 $testCar1965360481): void
        {
                                                if ($testCar1965360481->testCar21856512963s()->count() > 0) {
