...
trait IndexTrait
{
    ...
    {
        return TestCar920752408::paginate($this->perPage);
    }

            public function delete(TestCar920752408 $testCar920752408): void
        {
                                                if ($testCar920752408->testCar2446209195s()->count() > 0) {
