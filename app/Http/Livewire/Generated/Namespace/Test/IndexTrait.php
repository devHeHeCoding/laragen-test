...
trait IndexTrait
{
    ...
    {
        return TestCar1245180654::paginate($this->perPage);
    }

            public function delete(TestCar1245180654 $testCar1245180654): void
        {
                                                if ($testCar1245180654->testCar2232182887s()->count() > 0) {
