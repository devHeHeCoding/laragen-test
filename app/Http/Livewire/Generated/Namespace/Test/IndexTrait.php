...
trait IndexTrait
{
    ...
    {
        return TestCar1862278646::paginate($this->perPage);
    }

            public function delete(TestCar1862278646 $testCar1862278646): void
        {
                                                if ($testCar1862278646->testCar21545597835s()->count() > 0) {
