...
trait TestControllerTrait
{
    ...
    public function edit(TestCar1106150117 $testCar1106150117): View
    {
        if (BladeView::exists('app.namespace.test.edit')) {
            return view('app.namespace.test.edit', compact('testCar1106150117'));
        }

        return view('app.generated.namespace.test.edit', compact('testCar1106150117'));
    }
    public function show(TestCar1106150117 $testCar1106150117): View
    {
        if (BladeView::exists('app.namespace.test.show')) {
            return view('app.namespace.test.show', compact('testCar1106150117'));
        }

        return view('app.generated.namespace.test.show', compact('testCar1106150117'));
    }
}
