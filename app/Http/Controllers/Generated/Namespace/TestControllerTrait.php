...
trait TestControllerTrait
{
    ...
    public function edit(TestCar958059729 $testCar958059729): View
    {
        if (BladeView::exists('app.namespace.test.edit')) {
            return view('app.namespace.test.edit', compact('testCar958059729'));
        }

        return view('app.generated.namespace.test.edit', compact('testCar958059729'));
    }
    public function show(TestCar958059729 $testCar958059729): View
    {
        if (BladeView::exists('app.namespace.test.show')) {
            return view('app.namespace.test.show', compact('testCar958059729'));
        }

        return view('app.generated.namespace.test.show', compact('testCar958059729'));
    }
}
