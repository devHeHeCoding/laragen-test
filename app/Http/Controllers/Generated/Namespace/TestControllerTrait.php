...
trait TestControllerTrait
{
    ...
    public function edit(TestCar1218254650 $testCar1218254650): View
    {
        if (BladeView::exists('app.namespace.test.edit')) {
            return view('app.namespace.test.edit', compact('testCar1218254650'));
        }

        return view('app.generated.namespace.test.edit', compact('testCar1218254650'));
    }
    public function show(TestCar1218254650 $testCar1218254650): View
    {
        if (BladeView::exists('app.namespace.test.show')) {
            return view('app.namespace.test.show', compact('testCar1218254650'));
        }

        return view('app.generated.namespace.test.show', compact('testCar1218254650'));
    }
}
