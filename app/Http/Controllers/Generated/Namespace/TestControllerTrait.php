...
trait TestControllerTrait
{
    ...
    public function edit(TestCar1879320840 $testCar1879320840): View
    {
        if (BladeView::exists('app.namespace.test.edit')) {
            return view('app.namespace.test.edit', compact('testCar1879320840'));
        }

        return view('app.generated.namespace.test.edit', compact('testCar1879320840'));
    }
    public function show(TestCar1879320840 $testCar1879320840): View
    {
        if (BladeView::exists('app.namespace.test.show')) {
            return view('app.namespace.test.show', compact('testCar1879320840'));
        }

        return view('app.generated.namespace.test.show', compact('testCar1879320840'));
    }
}
