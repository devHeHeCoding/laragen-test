...
trait TestControllerTrait
{
    ...
    public function edit(TestCar207063216 $testCar207063216)
    {
        if (View::exists('app.namespace.test.edit')) {
            return view('app.namespace.test.edit', compact('testCar207063216'));
        }

        return view('app.generated.namespace.test.edit', compact('testCar207063216'));
    }

    public function show(TestCar207063216 $testCar207063216)
    {
        if (View::exists('app.generated.namespace.test.show')) {
            return view('app.generated.namespace.test.show', compact('testCar207063216'));
        }
