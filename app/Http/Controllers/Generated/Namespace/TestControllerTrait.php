...
trait TestControllerTrait
{
    ...
    public function edit(TestCar1974465717 $testCar1974465717): View
    {
        if (BladeView::exists('app.namespace.test.edit')) {
            return view('app.namespace.test.edit', compact('testCar1974465717'));
        }

        return view('app.generated.namespace.test.edit', compact('testCar1974465717'));
    }
    public function show(TestCar1974465717 $testCar1974465717): View
    {
        if (BladeView::exists('app.namespace.test.show')) {
            return view('app.namespace.test.show', compact('testCar1974465717'));
        }

        return view('app.generated.namespace.test.show', compact('testCar1974465717'));
    }
}
