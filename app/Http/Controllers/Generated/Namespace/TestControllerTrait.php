...
trait TestControllerTrait
{
    ...
    public function edit(TestCar521786102 $testCar521786102): View
    {
        if (BladeView::exists('app.namespace.test.edit')) {
            return view('app.namespace.test.edit', compact('testCar521786102'));
        }

        return view('app.generated.namespace.test.edit', compact('testCar521786102'));
    }
    public function show(TestCar521786102 $testCar521786102): View
    {
        if (BladeView::exists('app.namespace.test.show')) {
            return view('app.namespace.test.show', compact('testCar521786102'));
        }

        return view('app.generated.namespace.test.show', compact('testCar521786102'));
    }
}
