...
trait TestControllerTrait
{
    ...
    public function edit(TestCar1356840045 $testCar1356840045): View
    {
        if (BladeView::exists('app.namespace.test.edit')) {
            return view('app.namespace.test.edit', compact('testCar1356840045'));
        }

        return view('app.generated.namespace.test.edit', compact('testCar1356840045'));
    }
    public function show(TestCar1356840045 $testCar1356840045): View
    {
        if (BladeView::exists('app.namespace.test.show')) {
            return view('app.namespace.test.show', compact('testCar1356840045'));
        }

        return view('app.generated.namespace.test.show', compact('testCar1356840045'));
    }
}
