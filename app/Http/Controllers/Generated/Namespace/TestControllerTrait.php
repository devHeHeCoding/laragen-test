...
trait TestControllerTrait
{
    ...
    public function edit(TestCar1498983619 $testCar1498983619): View
    {
        if (BladeView::exists('app.namespace.test.edit')) {
            return view('app.namespace.test.edit', compact('testCar1498983619'));
        }

        return view('app.generated.namespace.test.edit', compact('testCar1498983619'));
    }
    public function show(TestCar1498983619 $testCar1498983619): View
    {
        if (BladeView::exists('app.namespace.test.show')) {
            return view('app.namespace.test.show', compact('testCar1498983619'));
        }

        return view('app.generated.namespace.test.show', compact('testCar1498983619'));
    }
}
