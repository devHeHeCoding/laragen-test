...
trait TestControllerTrait
{
    ...
    public function edit(TestCar1288517886 $testCar1288517886): View
    {
        if (BladeView::exists('app.namespace.test.edit')) {
            return view('app.namespace.test.edit', compact('testCar1288517886'));
        }

        return view('app.generated.namespace.test.edit', compact('testCar1288517886'));
    }
    public function show(TestCar1288517886 $testCar1288517886): View
    {
        if (BladeView::exists('app.namespace.test.show')) {
            return view('app.namespace.test.show', compact('testCar1288517886'));
        }

        return view('app.generated.namespace.test.show', compact('testCar1288517886'));
    }
}
