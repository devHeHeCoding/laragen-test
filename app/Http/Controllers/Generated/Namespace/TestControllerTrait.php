...
trait TestControllerTrait
{
    ...
    public function edit(TestCar231510590 $testCar231510590): View
    {
        if (BladeView::exists('app.namespace.test.edit')) {
            return view('app.namespace.test.edit', compact('testCar231510590'));
        }

        return view('app.generated.namespace.test.edit', compact('testCar231510590'));
    }
    public function show(TestCar231510590 $testCar231510590): View
    {
        if (BladeView::exists('app.namespace.test.show')) {
            return view('app.namespace.test.show', compact('testCar231510590'));
        }

        return view('app.generated.namespace.test.show', compact('testCar231510590'));
    }
}
