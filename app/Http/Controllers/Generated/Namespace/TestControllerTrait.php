...
trait TestControllerTrait
{
    ...
    public function edit(TestCar1209094272 $testCar1209094272): View
    {
        if (BladeView::exists('app.namespace.test.edit')) {
            return view('app.namespace.test.edit', compact('testCar1209094272'));
        }

        return view('app.generated.namespace.test.edit', compact('testCar1209094272'));
    }
    public function show(TestCar1209094272 $testCar1209094272): View
    {
        if (BladeView::exists('app.namespace.test.show')) {
            return view('app.namespace.test.show', compact('testCar1209094272'));
        }

        return view('app.generated.namespace.test.show', compact('testCar1209094272'));
    }
}
