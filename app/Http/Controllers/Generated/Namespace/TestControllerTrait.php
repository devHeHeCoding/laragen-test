...
trait TestControllerTrait
{
    ...
    public function edit(TestCar1044297656 $testCar1044297656): View
    {
        if (BladeView::exists('app.namespace.test.edit')) {
            return view('app.namespace.test.edit', compact('testCar1044297656'));
        }

        return view('app.generated.namespace.test.edit', compact('testCar1044297656'));
    }
    public function show(TestCar1044297656 $testCar1044297656): View
    {
        if (BladeView::exists('app.namespace.test.show')) {
            return view('app.namespace.test.show', compact('testCar1044297656'));
        }

        return view('app.generated.namespace.test.show', compact('testCar1044297656'));
    }
}
