...
trait TestControllerTrait
{
    ...
    public function edit(TestCar467464683 $testCar467464683)
    {
        if (View::exists('app.namespace.test.edit')) {
            return view('app.namespace.test.edit', compact('testCar467464683'));
        }

        return view('app.generated.namespace.test.edit', compact('testCar467464683'));
    }

    public function show(TestCar467464683 $testCar467464683)
    {
        if (View::exists('app.generated.namespace.test.show')) {
            return view('app.generated.namespace.test.show', compact('testCar467464683'));
        }
