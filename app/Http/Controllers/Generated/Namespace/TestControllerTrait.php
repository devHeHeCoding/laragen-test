...
trait TestControllerTrait
{
    ...
    public function edit(TestCar1800910953 $testCar1800910953): View
    {
        if (BladeView::exists('app.namespace.test.edit')) {
            return view('app.namespace.test.edit', compact('testCar1800910953'));
        }

        return view('app.generated.namespace.test.edit', compact('testCar1800910953'));
    }
    public function show(TestCar1800910953 $testCar1800910953): View
    {
        if (BladeView::exists('app.namespace.test.show')) {
            return view('app.namespace.test.show', compact('testCar1800910953'));
        }

        return view('app.generated.namespace.test.show', compact('testCar1800910953'));
    }
}
