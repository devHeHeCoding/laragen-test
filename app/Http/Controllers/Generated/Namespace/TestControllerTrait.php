...
trait TestControllerTrait
{
    ...
    public function edit(TestCar1906832542 $testCar1906832542): View
    {
        if (BladeView::exists('app.namespace.test.edit')) {
            return view('app.namespace.test.edit', compact('testCar1906832542'));
        }

        return view('app.generated.namespace.test.edit', compact('testCar1906832542'));
    }
    public function show(TestCar1906832542 $testCar1906832542): View
    {
        if (BladeView::exists('app.namespace.test.show')) {
            return view('app.namespace.test.show', compact('testCar1906832542'));
        }

        return view('app.generated.namespace.test.show', compact('testCar1906832542'));
    }
}
