...
trait TestControllerTrait
{
    ...
    public function edit(namespace.test)
    {
        if (View::exists('app.namespace.test.edit')) {
            return view('app.namespace.test.edit', compact('testCar612343464'));
        }

        return view('app.generated.namespace.test.edit', compact('testCar612343464'));
    }

    public function show(TestCar612343464 $testCar612343464)
    {
        if (View::exists('app.generated.namespace.test.show')) {
            return view('app.generated.namespace.test.show', compact('testCar612343464'));
        }
