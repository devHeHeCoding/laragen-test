...
trait TestControllerTrait
{
    ...
    public function edit(TestCar1518294816 $testCar1518294816): View
    {
        if (BladeView::exists('app.namespace.test.edit')) {
            return view('app.namespace.test.edit', compact('testCar1518294816'));
        }

        return view('app.generated.namespace.test.edit', compact('testCar1518294816'));
    }
    public function show(TestCar1518294816 $testCar1518294816): View
    {
        if (BladeView::exists('app.namespace.test.show')) {
            return view('app.namespace.test.show', compact('testCar1518294816'));
        }

        return view('app.generated.namespace.test.show', compact('testCar1518294816'));
    }
}
