...
trait TestControllerTrait
{
    ...
    public function edit(TestCar172553734 $testCar172553734): View
    {
        if (BladeView::exists('app.namespace.test.edit')) {
            return view('app.namespace.test.edit', compact('testCar172553734'));
        }

        return view('app.generated.namespace.test.edit', compact('testCar172553734'));
    }
    public function show(TestCar172553734 $testCar172553734): View
    {
        if (BladeView::exists('app.namespace.test.show')) {
            return view('app.namespace.test.show', compact('testCar172553734'));
        }

        return view('app.generated.namespace.test.show', compact('testCar172553734'));
    }
}
