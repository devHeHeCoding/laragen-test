...
trait TestControllerTrait
{
    ...
    public function edit(TestCar1611957243 $testCar1611957243): View
    {
        if (BladeView::exists('app.namespace.test.edit')) {
            return view('app.namespace.test.edit', compact('testCar1611957243'));
        }

        return view('app.generated.namespace.test.edit', compact('testCar1611957243'));
    }

    public function show(TestCar1611957243 $testCar1611957243): View
    {
        if (BladeView::exists('app.generated.namespace.test.show')) {
            return view('app.generated.namespace.test.show', compact('testCar1611957243'));
        }
