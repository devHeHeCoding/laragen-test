...
trait TestControllerTrait
{
    ...
    public function edit(TestCar1669184493 $testCar1669184493): View
    {
        if (BladeView::exists('app.namespace.test.edit')) {
            return view('app.namespace.test.edit', compact('testCar1669184493'));
        }

        return view('app.generated.namespace.test.edit', compact('testCar1669184493'));
    }
    public function show(TestCar1669184493 $testCar1669184493): View
    {
        if (BladeView::exists('app.namespace.test.show')) {
            return view('app.namespace.test.show', compact('testCar1669184493'));
        }

        return view('app.generated.namespace.test.show', compact('testCar1669184493'));
    }
}
