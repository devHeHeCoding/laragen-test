...
trait TestControllerTrait
{
    ...
    public function edit(TestCar2100361536 $testCar2100361536): View
    {
        if (BladeView::exists('app.namespace.test.edit')) {
            return view('app.namespace.test.edit', compact('testCar2100361536'));
        }

        return view('app.generated.namespace.test.edit', compact('testCar2100361536'));
    }

    public function show(TestCar2100361536 $testCar2100361536): View
    {
        if (BladeView::exists('app.generated.namespace.test.show')) {
            return view('app.generated.namespace.test.show', compact('testCar2100361536'));
        }
