...
trait TestControllerTrait
{
    ...
    public function edit(TestCar1059676956 $testCar1059676956)
    {
        if (View::exists('app.namespace.test.edit')) {
            return view('app.namespace.test.edit', compact('testCar1059676956'));
        }

        return view('app.generated.namespace.test.edit', compact('testCar1059676956'));
    }

    public function show(TestCar1059676956 $testCar1059676956)
    {
        if (View::exists('app.generated.namespace.test.show')) {
            return view('app.generated.namespace.test.show', compact('testCar1059676956'));
        }
