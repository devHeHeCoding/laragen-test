...
trait TestControllerTrait
{
    ...
    public function edit(TestCar1201803055 $testCar1201803055)
    {
        if (View::exists('app.namespace.test.edit')) {
            return view('app.namespace.test.edit', compact('testCar1201803055'));
        }

        return view('app.generated.namespace.test.edit', compact('testCar1201803055'));
    }

    public function show(TestCar1201803055 $testCar1201803055)
    {
        if (View::exists('app.generated.namespace.test.show')) {
            return view('app.generated.namespace.test.show', compact('testCar1201803055'));
        }
