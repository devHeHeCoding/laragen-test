...
trait TestControllerTrait
{
    ...
    public function edit(TestCar876034793 $testCar876034793)
    {
        if (View::exists('app.namespace.test.edit')) {
            return view('app.namespace.test.edit', compact('testCar876034793'));
        }

        return view('app.generated.namespace.test.edit', compact('testCar876034793'));
    }

    public function show(TestCar876034793 $testCar876034793)
    {
        if (View::exists('app.generated.namespace.test.show')) {
            return view('app.generated.namespace.test.show', compact('testCar876034793'));
        }
