...
trait TestControllerTrait
{
    ...
    public function edit(TestCar1193705976 $testCar1193705976): View
    {
        if (BladeView::exists('app.namespace.test.edit')) {
            return view('app.namespace.test.edit', compact('testCar1193705976'));
        }

        return view('app.generated.namespace.test.edit', compact('testCar1193705976'));
    }

    public function show(TestCar1193705976 $testCar1193705976): View
    {
        if (BladeView::exists('app.generated.namespace.test.show')) {
            return view('app.generated.namespace.test.show', compact('testCar1193705976'));
        }
