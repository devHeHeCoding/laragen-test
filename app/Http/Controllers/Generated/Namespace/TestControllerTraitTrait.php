...
trait TestControllerTrait
{
    ...
    public function edit(TestCar1764321535 $testCar1764321535): View
    {
        if (BladeView::exists('app.namespace.test.edit')) {
            return view('app.namespace.test.edit', compact('testCar1764321535'));
        }

        return view('app.generated.namespace.test.edit', compact('testCar1764321535'));
    }

    public function show(TestCar1764321535 $testCar1764321535): View
    {
        if (BladeView::exists('app.generated.namespace.test.show')) {
            return view('app.generated.namespace.test.show', compact('testCar1764321535'));
        }
