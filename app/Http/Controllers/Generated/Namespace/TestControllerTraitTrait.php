...
trait TestControllerTrait
{
    ...
    public function edit(TestCar1299154322 $testCar1299154322): View
    {
        if (BladeView::exists('app.namespace.test.edit')) {
            return view('app.namespace.test.edit', compact('testCar1299154322'));
        }

        return view('app.generated.namespace.test.edit', compact('testCar1299154322'));
    }

    public function show(TestCar1299154322 $testCar1299154322): View
    {
        if (BladeView::exists('app.generated.namespace.test.show')) {
            return view('app.generated.namespace.test.show', compact('testCar1299154322'));
        }
